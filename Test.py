...
# ------------------------- 分頁切換 -------------------------
model_choice = st.sidebar.radio("請選擇要執行的模型", [
    "EOMG",
    "LOMG",
    "Thymoma",
    "Non-Thymoma"
...
def run_model_a_page():
    ...
    # 模型 & 資料（你之後替換正確路徑）
    model_dict = pickle.load(open(r"C:\Users\a0986\Streamlit_Project\ICU\Streamlit\Models\MG_ICU_SHAP_XGB_EOMG.pkl", "rb"))
    ...
    # 輸入變數
    Gender = st.sidebar.number_input("Gender", 1,2)
...
def run_model_b_page():
    ...
    # 模型 & 資料（你之後替換正確路徑）
    model_dict = pickle.load(open(r"C:\Users\a0986\Streamlit_Project\ICU\Streamlit\Models\MG_ICU_SHAP_XGB_LOMG.pkl", "rb"))
    model = model_dict['model']
    x = pd.read_csv(r"C:\Users\a0986\Streamlit_Project\ICU\Streamlit\MG_ICU_SHAP_Model_Data_SubGroup2_Age50U_New_FeaName.csv")
    x_train = x.drop(columns=[ "Y"])
    # 輸入變數
    Gender = st.sidebar.number_input("Gender", 1,2)
    BMI = st.sidebar.number_input("BMI", 10.0, 40.0, 22.5)
    ...
    PLR = st.sidebar.number_input("PLR", 0.0, 1000.0, 100.0)
    LMR = st.sidebar.number_input("LMR", 0.0, 20.0, 2.0)
    SII = st.sidebar.number_input("SII", 0.0, 1000000000.0, 100.0)
...
def run_model_c_page():
    ...
    # 模型 & 資料（你之後替換正確路徑）
    model_dict = pickle.load(open(r"C:\Users\a0986\Streamlit_Project\ICU\Streamlit\Models\MG_ICU_SHAP_XGB_Thymoma.pkl", "rb"))
    model = model_dict['model']
    x = pd.read_csv(r"C:\Users\a0986\Streamlit_Project\ICU\Streamlit\MG_ICU_SHAP_Model_Data_SubGroup1_X9_1_FeaName.csv")
    x_train = x.drop(columns=[ "Y"])
    # 輸入變數
    Gender = st.sidebar.number_input("Gender", 1,2)
    Age= st.sidebar.number_input("Age at onset (year)", 0, 100, 1)
    BMI = st.sidebar.number_input("BMI", 10.0, 40.0, 22.5)
    Recurrent_thymoma = st.sidebar.number_input("Recurrent thymoma", 0, 1, 0)
    Invasive_thymoma = st.sidebar.number_input("Invasive thymoma", 0, 1, 0)
    Infection = st.sidebar.number_input("Infection at admission", 0, 1, 0)
    Thyroid = st.sidebar.number_input("Thyroid disease", 0, 1, 0)
    Autoimmune= st.sidebar.number_input("Autoimmune disease", 0, 1, 0)
    Diabetes = st.sidebar.number_input("Diabetes", 0, 1, 0)
    Hypertension = st.sidebar.number_input("Hypertension", 0, 1,0)
    ASCVD = st.sidebar.number_input("ASCVD", 0, 1, 0)
    Chronic = st.sidebar.number_input("Chronic lung disease", 0, 1, 0)
    ...
    Prednisolone = st.sidebar.number_input("Prednisolone daily dose before admission", 0, 100, 0)
    Immunosuppressant = st.sidebar.number_input("Immunosuppressant at admission", 0, 1, 0)
    NLR = st.sidebar.number_input("NLR", 0.0, 20.0, 1.0)
    PLR = st.sidebar.number_input("PLR", 0.0, 1000.0, 100.0)
    LMR = st.sidebar.number_input("LMR", 0.0, 10.0, 1.0)
    SII = st.sidebar.number_input("SII", 0.0, 10000000.0, 100.0)
...
def run_model_d_page():
    ...
    # 模型 & 資料（你之後替換正確路徑）
    model_dict = pickle.load(open(r"C:\Users\a0986\Streamlit_Project\ICU\Streamlit\Models\MG_ICU_SHAP_XGB_NonThymoma.pkl", "rb"))
    model = model_dict['model']
    x = pd.read_csv(r"C:\Users\a0986\Streamlit_Project\ICU\Streamlit\MG_ICU_SHAP_Model_Data_SubGroup1_X9_0_FeaName.csv")
    x_train = x.drop(columns=[ "Y"])
    # 輸入變數
    Gender = st.sidebar.number_input("Gender", 1,2)
    Age= st.sidebar.number_input("Age at onset (year)", 0, 100, 1)
    ...
    Immunosuppressant = st.sidebar.number_input("Immunosuppressant at admission", 0, 1, 0)
    NLR = st.sidebar.number_input("NLR", 0.0, 20.0, 1.0)
    PLR = st.sidebar.number_input("PLR", 0.0, 1000.0, 10.0)
    LMR = st.sidebar.number_input("LMR", 0.0, 10.0, 1.0)
    SII = st.sidebar.number_input("SII", 0.0, 10000000.0, 100.0)
